...
class Size
{
    ...
    {
        $size = self::get_instance();
        $size->init();
        

        add_filter(
            "image_resize_dimensions",
            ["\\WPBuilder\\utils\\Upscale", "resize"],
            10,
            6
        );
        ...
        add_action("init", function () {
            ...
            // Exemple full-width
            Size::add("image-xl-2x", 3840, self::FULL_SIZE, false);
            Size::add("image-xl", 1920, self::FULL_SIZE, false);
            Size::add("image-l-2x", 2560, self::FULL_SIZE, false);
            Size::add("image-l", 1280, self::FULL_SIZE, false);
            Size::add("image-m-2x", 1720, self::FULL_SIZE, false);
            Size::add("image-m", 860, self::FULL_SIZE, false);
            Size::add("image-s-2x", 800, self::FULL_SIZE, false);
            Size::add("image-s", 400, self::FULL_SIZE, false);
        });
    }
